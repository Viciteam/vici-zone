        ...
        return (
            <div className="">
                <div className="container mx-auto mt-3">
                    <div className="text-center text-28 font-bold headline-tag">Thanks a bunch for joining our waitlist.</div>
                    <div className="text-center font-bold text-primary_color text-64 headline-title">Become VIP waitlist member for just $1</div>
                </div>
                <div className="mt-12">
