           ...
           <div className="w-8/12 mx-auto">
               <div className="font-bold md:text-28 text-xl text-center text-vici_secondary_text">
                ...
                <div className="mt-3 w-full xl:w-1/4 lg:w-1/2 mx-auto">
                    <input type="text" placeholder="Enter your name" className="w-full px-3 py-2 border text-center border-bottom_gray" />
                    <input type="email" placeholder="Enter your email" className="w-full px-3 mt-3 py-2 border text-center border-bottom_gray" />
                    <button className="w-full px-3 mt-3 py-2 bg-primary_color flex justify-center text-white_color rounded-sm">
                        <div className="flex">
